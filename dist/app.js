...
class Meetkacey extends Component {}

var __ui_components_Meetkacey_template__ = { "id": "DD5IQzpx", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[8],[6,\"h1\"],[8],[0,\"Welcome to Glimmer!\"],[9],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "specifier": "template:/meetkacey/components/Meetkacey" } };

var moduleMap = { 'component:/meetkacey/components/Meetkacey': Meetkacey, 'template:/meetkacey/components/Meetkacey': __ui_components_Meetkacey_template__ };

var resolverConfiguration = { "app": { "name": "meetkacey", "rootName": "meetkacey" }, "types": { "application": { "definitiveCollection": "main" }, "component": { "definitiveCollection": "components" }, "component-test": { "unresolvable": true }, "helper": { "definitiveCollection": "components" }, "helper-test": { "unresolvable": true }, "renderer": { "definitiveCollection": "main" }, "template": { "definitiveCollection": "components" } }, "collections": { "main": { "types": ["application", "renderer"] }, "components": { "group": "ui", "types": ["component", "component-test", "template", "helper", "helper-test"], "defaultType": "component", "privateCollections": ["utils"] }, "styles": { "group": "ui", "unresolvable": true }, "utils": { "unresolvable": true } } };
...
app.renderComponent('Meetkacey', containerElement, null);
app.boot();
